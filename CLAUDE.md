...
2. **Chrome Extension** (chrome-extension/): Detects check-ins on TwoTimTwo.com and sends labels to the local print server.
...
- `node scripts/bump-version.cjs <X.Y.Z>`: Mandatory version bump
...
- **Chrome Extension** fetches CSV and POSTs to localhost:3456/update-csv.
