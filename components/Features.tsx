...
const FEATURES: { icon: string; title: string; body: string; isNew?: boolean }[] = [
  ...
  { icon: '🎂', title: 'Birthday stickers', body: 'During a child’s birthday week an extra festive HAPPY BIRTHDAY sticker prints automatically with their label.', isNew: true },
  { icon: '🏆', title: 'Milestone stickers', body: 'Every 5th night at Awana — and 3, 5, 10+ week streaks — earns a surprise celebration sticker at check-in.', isNew: true },
