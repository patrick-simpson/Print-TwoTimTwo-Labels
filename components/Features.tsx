...
const FEATURES: { icon: string; title: string; body: string; isNew?: boolean }[] = [
  ...
  { icon: '🎂', title: 'Birthday stickers', body: 'During a child’s birthday week a fun “My birthday is this week!” sticker prints automatically with their label.', isNew: true },
  { icon: '🏆', title: 'Milestone stickers', body: 'Every 5th night at Awana earns a surprise “Way to go!” celebration sticker right at check-in.', isNew: true },
